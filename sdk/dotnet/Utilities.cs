...
namespace Pulumi.Sbercloud
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Sbercloud.version.txt");
    ...
    internal sealed class SbercloudResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public SbercloudResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
