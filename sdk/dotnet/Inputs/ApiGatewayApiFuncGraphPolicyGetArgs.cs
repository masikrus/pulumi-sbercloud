...
namespace Pulumi.Sbercloud.Inputs
{
    ...
    public sealed class ApiGatewayApiFuncGraphPolicyGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("backendParams")]
        private InputList<Inputs.ApiGatewayApiFuncGraphPolicyBackendParamGetArgs>? _backendParams;

        /// <summary>
        /// The configaiton list of the backend parameters.
        /// </summary>
        public InputList<Inputs.ApiGatewayApiFuncGraphPolicyBackendParamGetArgs> BackendParams
        {
            get => _backendParams ?? (_backendParams = new InputList<Inputs.ApiGatewayApiFuncGraphPolicyBackendParamGetArgs>());
            set => _backendParams = value;
        }

        [Input("conditions", required: true)]
        private InputList<Inputs.ApiGatewayApiFuncGraphPolicyConditionGetArgs>? _conditions;

        /// <summary>
        /// The policy conditions.
        /// </summary>
        public InputList<Inputs.ApiGatewayApiFuncGraphPolicyConditionGetArgs> Conditions
        {
            get => _conditions ?? (_conditions = new InputList<Inputs.ApiGatewayApiFuncGraphPolicyConditionGetArgs>());
        ...
        public ApiGatewayApiFuncGraphPolicyGetArgs()
        {
        }
        public static new ApiGatewayApiFuncGraphPolicyGetArgs Empty => new ApiGatewayApiFuncGraphPolicyGetArgs();
    }
}
