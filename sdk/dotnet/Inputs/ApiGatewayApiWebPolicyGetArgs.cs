...
namespace Pulumi.Sbercloud.Inputs
{
    ...
    public sealed class ApiGatewayApiWebPolicyGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("backendParams")]
        private InputList<Inputs.ApiGatewayApiWebPolicyBackendParamGetArgs>? _backendParams;

        /// <summary>
        /// The configuration list of the backend parameters.
        /// </summary>
        public InputList<Inputs.ApiGatewayApiWebPolicyBackendParamGetArgs> BackendParams
        {
            get => _backendParams ?? (_backendParams = new InputList<Inputs.ApiGatewayApiWebPolicyBackendParamGetArgs>());
            set => _backendParams = value;
        }

        [Input("conditions", required: true)]
        private InputList<Inputs.ApiGatewayApiWebPolicyConditionGetArgs>? _conditions;

        /// <summary>
        /// The policy conditions.
        /// </summary>
        public InputList<Inputs.ApiGatewayApiWebPolicyConditionGetArgs> Conditions
        {
            get => _conditions ?? (_conditions = new InputList<Inputs.ApiGatewayApiWebPolicyConditionGetArgs>());
        ...
        public ApiGatewayApiWebPolicyGetArgs()
        {
        }
        public static new ApiGatewayApiWebPolicyGetArgs Empty => new ApiGatewayApiWebPolicyGetArgs();
    }
}
