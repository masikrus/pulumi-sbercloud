...
namespace Pulumi.Sbercloud.Inputs
{
    ...
    public sealed class ApigApiFuncGraphPolicyArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("backendParams")]
        private InputList<Inputs.ApigApiFuncGraphPolicyBackendParamArgs>? _backendParams;

        /// <summary>
        /// The configaiton list of the backend parameters.
        /// </summary>
        public InputList<Inputs.ApigApiFuncGraphPolicyBackendParamArgs> BackendParams
        {
            get => _backendParams ?? (_backendParams = new InputList<Inputs.ApigApiFuncGraphPolicyBackendParamArgs>());
            set => _backendParams = value;
        }

        [Input("conditions", required: true)]
        private InputList<Inputs.ApigApiFuncGraphPolicyConditionArgs>? _conditions;

        /// <summary>
        /// The policy conditions.
        /// </summary>
        public InputList<Inputs.ApigApiFuncGraphPolicyConditionArgs> Conditions
        {
            get => _conditions ?? (_conditions = new InputList<Inputs.ApigApiFuncGraphPolicyConditionArgs>());
        ...
        public ApigApiFuncGraphPolicyArgs()
        {
        }
        public static new ApigApiFuncGraphPolicyArgs Empty => new ApigApiFuncGraphPolicyArgs();
    }
}
