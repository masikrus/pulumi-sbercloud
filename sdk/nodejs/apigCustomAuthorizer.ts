...
export class ApigCustomAuthorizer extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ApigCustomAuthorizerState, opts?: pulumi.CustomResourceOptions): ApigCustomAuthorizer {
        return new ApigCustomAuthorizer(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'sbercloud:index/apigCustomAuthorizer:ApigCustomAuthorizer';

    /**
     * Returns true if the given object is an instance of ApigCustomAuthorizer.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ApigCustomAuthorizer {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ApigCustomAuthorizer.__pulumiType;
    }
     ...
     */
    public readonly identities!: pulumi.Output<outputs.ApigCustomAuthorizerIdentity[] | undefined>;
    /**
     ...
     */
    constructor(name: string, args: ApigCustomAuthorizerArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ApigCustomAuthorizerArgs | ApigCustomAuthorizerState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ApigCustomAuthorizerState | undefined;
            ...
            const args = argsOrState as ApigCustomAuthorizerArgs | undefined;
        ...
        super(ApigCustomAuthorizer.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface ApigCustomAuthorizerState {
    /**
     * The maximum cache age.
     */
     ...
     * The array of one or more parameter identities of the custom authorizer.
     */
    identities?: pulumi.Input<pulumi.Input<inputs.ApigCustomAuthorizerIdentity>[]>;
    /**
     * The ID of the dedicated instance to which the custom authorizer belongs.
     */
 ...
 */
export interface ApigCustomAuthorizerArgs {
    /**
     * The maximum cache age.
     */
    cacheAge?: pulumi.Input<number>;
