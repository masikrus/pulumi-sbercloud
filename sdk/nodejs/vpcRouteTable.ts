...
export class VpcRouteTable extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'sbercloud:index/vpcRouteTable:VpcRouteTable';
    ...
    public readonly routes!: pulumi.Output<outputs.VpcRouteTableRoute[]>;
...
export interface VpcRouteTableState {
    ...
    routes?: pulumi.Input<pulumi.Input<inputs.VpcRouteTableRoute>[]>;
