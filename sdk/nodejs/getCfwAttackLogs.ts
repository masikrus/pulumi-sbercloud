...
export function getCfwAttackLogs(args: GetCfwAttackLogsArgs, opts?: pulumi.InvokeOptions): Promise<GetCfwAttackLogsResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("sbercloud:index/getCfwAttackLogs:getCfwAttackLogs", {
        "app": args.app,
 ...
 */
export interface GetCfwAttackLogsArgs {
    app?: string;
    attackRule?: string;
    attackRuleId?: string;
    attackType?: string;
 ...
 */
export interface GetCfwAttackLogsResult {
    readonly app?: string;
    ...
    readonly records: outputs.GetCfwAttackLogsRecord[];
...
export function getCfwAttackLogsOutput(args: GetCfwAttackLogsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCfwAttackLogsResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("sbercloud:index/getCfwAttackLogs:getCfwAttackLogs", {
        "app": args.app,
        "attackRule": args.attackRule,
        "attackRuleId": args.attackRuleId,
        "attackType": args.attackType,
 ...
 * A collection of arguments for invoking getCfwAttackLogs.
 */
export interface GetCfwAttackLogsOutputArgs {
