...
export class CtsTracker extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CtsTrackerState, opts?: pulumi.CustomResourceOptions): CtsTracker {
        return new CtsTracker(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'sbercloud:index/ctsTracker:CtsTracker';

    /**
     * Returns true if the given object is an instance of CtsTracker.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is CtsTracker {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === CtsTracker.__pulumiType;
    }
     ...
     */
    constructor(name: string, args?: CtsTrackerArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: CtsTrackerArgs | CtsTrackerState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as CtsTrackerState | undefined;
            ...
            const args = argsOrState as CtsTrackerArgs | undefined;
        ...
        super(CtsTracker.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface CtsTrackerState {
 ...
 */
export interface CtsTrackerArgs {
    bucketName?: pulumi.Input<string>;
    compressType?: pulumi.Input<string>;
    deleteTracker?: pulumi.Input<boolean>;
    enabled?: pulumi.Input<boolean>;
