...
export class ApigThrottlingPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ApigThrottlingPolicyState, opts?: pulumi.CustomResourceOptions): ApigThrottlingPolicy {
        return new ApigThrottlingPolicy(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'sbercloud:index/apigThrottlingPolicy:ApigThrottlingPolicy';

    /**
     * Returns true if the given object is an instance of ApigThrottlingPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ApigThrottlingPolicy {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ApigThrottlingPolicy.__pulumiType;
    }

    /**
     * The array of one or more special throttling policies for APP limit.
     */
    public readonly appThrottles!: pulumi.Output<outputs.ApigThrottlingPolicyAppThrottle[] | undefined>;
    /**
     ...
     */
    public readonly userThrottles!: pulumi.Output<outputs.ApigThrottlingPolicyUserThrottle[] | undefined>;
     ...
     */
    constructor(name: string, args: ApigThrottlingPolicyArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ApigThrottlingPolicyArgs | ApigThrottlingPolicyState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ApigThrottlingPolicyState | undefined;
            ...
            const args = argsOrState as ApigThrottlingPolicyArgs | undefined;
        ...
        super(ApigThrottlingPolicy.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface ApigThrottlingPolicyState {
    /**
     * The array of one or more special throttling policies for APP limit.
     */
    appThrottles?: pulumi.Input<pulumi.Input<inputs.ApigThrottlingPolicyAppThrottle>[]>;
    /**
     * The creation time of the throttling policy.
     */
     ...
     * The array of one or more special throttling policies for IAM user limit.
     */
    userThrottles?: pulumi.Input<pulumi.Input<inputs.ApigThrottlingPolicyUserThrottle>[]>;
}

/**
 * The set of arguments for constructing a ApigThrottlingPolicy resource.
 */
export interface ApigThrottlingPolicyArgs {
    /**
     * The array of one or more special throttling policies for APP limit.
     */
    appThrottles?: pulumi.Input<pulumi.Input<inputs.ApigThrottlingPolicyAppThrottle>[]>;
