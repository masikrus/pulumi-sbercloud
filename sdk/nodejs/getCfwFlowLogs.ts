...
export function getCfwFlowLogs(args: GetCfwFlowLogsArgs, opts?: pulumi.InvokeOptions): Promise<GetCfwFlowLogsResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("sbercloud:index/getCfwFlowLogs:getCfwFlowLogs", {
        "app": args.app,
 ...
 */
export interface GetCfwFlowLogsArgs {
    app?: string;
    direction?: string;
    dstCityName?: string;
    dstIp?: string;
 ...
 */
export interface GetCfwFlowLogsResult {
    readonly app?: string;
     ...
     */
    readonly id: string;
    readonly records: outputs.GetCfwFlowLogsRecord[];
...
export function getCfwFlowLogsOutput(args: GetCfwFlowLogsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCfwFlowLogsResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("sbercloud:index/getCfwFlowLogs:getCfwFlowLogs", {
        "app": args.app,
        "direction": args.direction,
        "dstCityName": args.dstCityName,
        "dstIp": args.dstIp,
 ...
 * A collection of arguments for invoking getCfwFlowLogs.
 */
export interface GetCfwFlowLogsOutputArgs {
