...
export class ApiGatewayGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'sbercloud:index/apiGatewayGroup:ApiGatewayGroup';
     ...
     */
    public readonly environments!: pulumi.Output<outputs.ApiGatewayGroupEnvironment[]>;
    /**
    ...
    constructor(name: string, argsOrState?: ApiGatewayGroupArgs | ApiGatewayGroupState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ApiGatewayGroup.__pulumiType, name, resourceInputs, opts);
    }
}
...
export interface ApiGatewayGroupState {
     ...
     * The array of one or more environments of the associated group.
     */
    environments?: pulumi.Input<pulumi.Input<inputs.ApiGatewayGroupEnvironment>[]>;
    /**
     * Whether to delete all sub-resources (for API) from this group.
     */
