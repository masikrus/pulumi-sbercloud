...
export class RdsPgSqlLimit extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RdsPgSqlLimitState, opts?: pulumi.CustomResourceOptions): RdsPgSqlLimit {
        return new RdsPgSqlLimit(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'sbercloud:index/rdsPgSqlLimit:RdsPgSqlLimit';

    /**
     * Returns true if the given object is an instance of RdsPgSqlLimit.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is RdsPgSqlLimit {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === RdsPgSqlLimit.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: RdsPgSqlLimitArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: RdsPgSqlLimitArgs | RdsPgSqlLimitState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as RdsPgSqlLimitState | undefined;
            ...
            const args = argsOrState as RdsPgSqlLimitArgs | undefined;
        ...
        super(RdsPgSqlLimit.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface RdsPgSqlLimitState {
    /**
     * Specifies the name of the database.
     */
 ...
 */
export interface RdsPgSqlLimitArgs {
    /**
     * Specifies the name of the database.
     */
    dbName: pulumi.Input<string>;
