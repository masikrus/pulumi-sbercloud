...
export class ImagesImage extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ImagesImageState, opts?: pulumi.CustomResourceOptions): ImagesImage {
        return new ImagesImage(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'sbercloud:index/imagesImage:ImagesImage';

    /**
     * Returns true if the given object is an instance of ImagesImage.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ImagesImage {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ImagesImage.__pulumiType;
    }
     ...
     */
    constructor(name: string, args?: ImagesImageArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ImagesImageArgs | ImagesImageState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ImagesImageState | undefined;
            ...
            const args = argsOrState as ImagesImageArgs | undefined;
        ...
        super(ImagesImage.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface ImagesImageState {
 ...
 */
export interface ImagesImageArgs {
    backupId?: pulumi.Input<string>;
    cmkId?: pulumi.Input<string>;
    description?: pulumi.Input<string>;
    enterpriseProjectId?: pulumi.Input<string>;
