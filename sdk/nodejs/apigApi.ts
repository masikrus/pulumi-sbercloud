...
export class ApigApi extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ApigApiState, opts?: pulumi.CustomResourceOptions): ApigApi {
        return new ApigApi(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'sbercloud:index/apigApi:ApigApi';

    /**
     * Returns true if the given object is an instance of ApigApi.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ApigApi {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ApigApi.__pulumiType;
    }
     ...
     */
    public readonly backendParams!: pulumi.Output<outputs.ApigApiBackendParam[] | undefined>;
    /**
     ...
     */
    public readonly funcGraph!: pulumi.Output<outputs.ApigApiFuncGraph>;
    /**
     * The policy backends of the FunctionGraph function.
     */
    public readonly funcGraphPolicies!: pulumi.Output<outputs.ApigApiFuncGraphPolicy[] | undefined>;
    /**
     ...
     */
    public readonly mock!: pulumi.Output<outputs.ApigApiMock>;
    /**
     * The mock policy backends.
     */
    public readonly mockPolicies!: pulumi.Output<outputs.ApigApiMockPolicy[] | undefined>;
    /**
     * The API name.
     */
     ...
     */
    public readonly requestParams!: pulumi.Output<outputs.ApigApiRequestParam[]>;
    /**
     * The request address.
     */
     ...
     */
    public readonly web!: pulumi.Output<outputs.ApigApiWeb>;
    /**
     * The web policy backends.
     */
    public readonly webPolicies!: pulumi.Output<outputs.ApigApiWebPolicy[] | undefined>;
     ...
     */
    constructor(name: string, args: ApigApiArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ApigApiArgs | ApigApiState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ApigApiState | undefined;
            ...
            const args = argsOrState as ApigApiArgs | undefined;
        ...
        super(ApigApi.__pulumiType, name, resourceInputs, opts);
    }
}
...
export interface ApigApiState {
     ...
     * The configurations of the backend parameters.
     */
    backendParams?: pulumi.Input<pulumi.Input<inputs.ApigApiBackendParam>[]>;
    /**
     * The description of the API request body, which can be an example request body, media type or parameters.
     */
     ...
     * The FunctionGraph backend details.
     */
    funcGraph?: pulumi.Input<inputs.ApigApiFuncGraph>;
    /**
     * The policy backends of the FunctionGraph function.
     */
    funcGraphPolicies?: pulumi.Input<pulumi.Input<inputs.ApigApiFuncGraphPolicy>[]>;
    /**
     * The ID of the API group to which the API belongs.
     */
     ...
     * The mock backend details.
     */
    mock?: pulumi.Input<inputs.ApigApiMock>;
    /**
     * The mock policy backends.
     */
    mockPolicies?: pulumi.Input<pulumi.Input<inputs.ApigApiMockPolicy>[]>;
    /**
     * The API name.
     */
     ...
     * The configurations of the front-end parameters.
     */
    requestParams?: pulumi.Input<pulumi.Input<inputs.ApigApiRequestParam>[]>;
    /**
     * The request address.
     */
     ...
     * The web backend details.
     */
    web?: pulumi.Input<inputs.ApigApiWeb>;
    /**
     * The web policy backends.
     */
    webPolicies?: pulumi.Input<pulumi.Input<inputs.ApigApiWebPolicy>[]>;
}

/**
 * The set of arguments for constructing a ApigApi resource.
 */
export interface ApigApiArgs {
    /**
     * The ID of the authorizer to which the API request used.
     */
    authorizerId?: pulumi.Input<string>;
