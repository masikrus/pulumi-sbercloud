...
export class ApigInstance extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ApigInstanceState, opts?: pulumi.CustomResourceOptions): ApigInstance {
        return new ApigInstance(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'sbercloud:index/apigInstance:ApigInstance';

    /**
     * Returns true if the given object is an instance of ApigInstance.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ApigInstance {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ApigInstance.__pulumiType;
    }
     ...
     */
    public readonly customIngressPorts!: pulumi.Output<outputs.ApigInstanceCustomIngressPort[] | undefined>;
    /**
     ...
     */
    constructor(name: string, args: ApigInstanceArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ApigInstanceArgs | ApigInstanceState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ApigInstanceState | undefined;
            ...
            const args = argsOrState as ApigInstanceArgs | undefined;
        ...
        super(ApigInstance.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface ApigInstanceState {
    /**
     * schema: Required; The name list of availability zones for the dedicated instance.
     */
     ...
     * Specified the list of the instance custom ingress ports.
     */
    customIngressPorts?: pulumi.Input<pulumi.Input<inputs.ApigInstanceCustomIngressPort>[]>;
    /**
     * The description of the dedicated instance.
     */
 ...
 */
export interface ApigInstanceArgs {
    /**
     * schema: Required; The name list of availability zones for the dedicated instance.
     */
    availabilityZones?: pulumi.Input<pulumi.Input<string>[]>;
