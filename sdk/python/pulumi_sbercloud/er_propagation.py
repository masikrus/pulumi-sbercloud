...
__all__ = ['ErPropagationArgs', 'ErPropagation']

@pulumi.input_type
class ErPropagationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] attachment_id: The ID of the attachment corresponding to the propagation.
        ...
        :param pulumi.Input[builtins.str] route_table_id: The ID of the route table to which the propagation belongs.
...
class ErPropagation(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a ErPropagation resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: ErPropagationArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a ErPropagation resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param ErPropagationArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ErPropagationArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ErPropagationArgs.__new__(ErPropagationArgs)
        ...
        super(ErPropagation, __self__).__init__(
            'sbercloud:index/erPropagation:ErPropagation',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            route_table_id: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            updated_at: Optional[pulumi.Input[builtins.str]] = None) -> 'ErPropagation':
        """
        ...
        __props__ = _ErPropagationState.__new__(_ErPropagationState)
        ...
        return ErPropagation(resource_name, opts=opts, __props__=__props__)
