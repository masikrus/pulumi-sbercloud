...
__all__ = [
    'GetErPropagationsResult',
    'AwaitableGetErPropagationsResult',
    'get_er_propagations',
    'get_er_propagations_output',
]

@pulumi.output_type
class GetErPropagationsResult:
    """
    ...
    @property
    @pulumi.getter
    def propagations(self) -> Sequence['outputs.GetErPropagationsPropagationResult']:
...
class AwaitableGetErPropagationsResult(GetErPropagationsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetErPropagationsResult(
...
def get_er_propagations(attachment_id: Optional[builtins.str] = None,
                        attachment_type: Optional[builtins.str] = None,
                        instance_id: Optional[builtins.str] = None,
                        region: Optional[builtins.str] = None,
                        route_table_id: Optional[builtins.str] = None,
                        status: Optional[builtins.str] = None,
                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetErPropagationsResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('sbercloud:index/getErPropagations:getErPropagations', __args__, opts=opts, typ=GetErPropagationsResult).value

    return AwaitableGetErPropagationsResult(
...
def get_er_propagations_output(attachment_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                               ...
                               opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetErPropagationsResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('sbercloud:index/getErPropagations:getErPropagations', __args__, opts=opts, typ=GetErPropagationsResult)
    return __ret__.apply(lambda __response__: GetErPropagationsResult(
