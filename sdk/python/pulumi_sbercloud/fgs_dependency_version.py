...
class FgsDependencyVersionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] runtime: The runtime of the custom dependency package version.
        :param pulumi.Input[builtins.str] description: The description of the custom dependency version.
        :param pulumi.Input[builtins.str] name: The name of the custom dependency package to which the version belongs.
        :param pulumi.Input[builtins.str] region: The region where the custom dependency version is located.
        """
