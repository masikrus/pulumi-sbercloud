...
__all__ = ['ErInstanceArgs', 'ErInstance']

@pulumi.input_type
class ErInstanceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] asn: The BGP AS number of the Enterprise router.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] availability_zones: The availability zone list where the Enterprise router is located.
        :param pulumi.Input[builtins.bool] auto_accept_shared_attachments: Whether to automatically accept the creation of shared attachment.
        ...
        :param pulumi.Input[builtins.str] description: The description of the Enterprise router.
        ...
        :param pulumi.Input[builtins.str] enterprise_project_id: The enterprise project ID to which the Enterprise router belongs.
...
class ErInstance(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a ErInstance resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
        ...
        Create a ErInstance resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param ErInstanceArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ErInstanceArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ErInstanceArgs.__new__(ErInstanceArgs)
        ...
        super(ErInstance, __self__).__init__(
            'sbercloud:index/erInstance:ErInstance',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            updated_at: Optional[pulumi.Input[builtins.str]] = None) -> 'ErInstance':
        """
        ...
        __props__ = _ErInstanceState.__new__(_ErInstanceState)
        ...
        return ErInstance(resource_name, opts=opts, __props__=__props__)
