...
__all__ = [
    'GetErFlowLogsResult',
    'AwaitableGetErFlowLogsResult',
    'get_er_flow_logs',
    'get_er_flow_logs_output',
]

@pulumi.output_type
class GetErFlowLogsResult:
    """
    ...
    def flow_logs(self) -> Sequence['outputs.GetErFlowLogsFlowLogResult']:
...
class AwaitableGetErFlowLogsResult(GetErFlowLogsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetErFlowLogsResult(
...
def get_er_flow_logs(enabled: Optional[builtins.str] = None,
                     ...
                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetErFlowLogsResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('sbercloud:index/getErFlowLogs:getErFlowLogs', __args__, opts=opts, typ=GetErFlowLogsResult).value

    return AwaitableGetErFlowLogsResult(
...
def get_er_flow_logs_output(enabled: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                            ...
                            opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetErFlowLogsResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('sbercloud:index/getErFlowLogs:getErFlowLogs', __args__, opts=opts, typ=GetErFlowLogsResult)
    return __ret__.apply(lambda __response__: GetErFlowLogsResult(
