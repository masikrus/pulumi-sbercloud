...
class DmsRocketmqInstanceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] availability_zones: Specifies the list of availability zone names
        :param pulumi.Input[builtins.str] engine_version: Specifies the version of the RocketMQ engine.
        :param pulumi.Input[builtins.str] flavor_id: Specifies a product ID
        ...
        :param pulumi.Input[builtins.bool] enable_publicip: Specifies whether to enable public access.
        :param pulumi.Input[builtins.str] enterprise_project_id: Specifies the enterprise project id of the instance.
        :param pulumi.Input[builtins.bool] ipv6_enable: Specifies whether to support IPv6
        :param pulumi.Input[builtins.str] name: Specifies the name of the DMS RocketMQ instance
        :param pulumi.Input[builtins.str] publicip_id: Specifies the ID of the EIP bound to the instance.
        :param pulumi.Input[builtins.bool] retention_policy: Specifies whether access control is enabled.
        :param pulumi.Input[builtins.bool] ssl_enable: Specifies whether the RocketMQ SASL_SSL is enabled.
        """
...
class _DmsRocketmqInstanceState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] retention_policy: Specifies whether access control is enabled.
        :param pulumi.Input[builtins.str] security_group_id: Specifies the ID of a security group
        :param pulumi.Input[builtins.str] specification: Indicates the instance specification. For a cluster DMS RocketMQ instance, VM specifications and the number of nodes are
               returned.
        :param pulumi.Input[builtins.bool] ssl_enable: Specifies whether the RocketMQ SASL_SSL is enabled.
