...
__all__ = [
    'GetCfwAttackLogsResult',
    'AwaitableGetCfwAttackLogsResult',
    'get_cfw_attack_logs',
    'get_cfw_attack_logs_output',
]

@pulumi.output_type
class GetCfwAttackLogsResult:
    """
    ...
    @property
    @pulumi.getter
    def records(self) -> Sequence['outputs.GetCfwAttackLogsRecordResult']:
...
class AwaitableGetCfwAttackLogsResult(GetCfwAttackLogsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCfwAttackLogsResult(
            app=self.app,
...
def get_cfw_attack_logs(app: Optional[builtins.str] = None,
                        ...
                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCfwAttackLogsResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('sbercloud:index/getCfwAttackLogs:getCfwAttackLogs', __args__, opts=opts, typ=GetCfwAttackLogsResult).value

    return AwaitableGetCfwAttackLogsResult(
...
def get_cfw_attack_logs_output(app: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                               ...
                               opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetCfwAttackLogsResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('sbercloud:index/getCfwAttackLogs:getCfwAttackLogs', __args__, opts=opts, typ=GetCfwAttackLogsResult)
    return __ret__.apply(lambda __response__: GetCfwAttackLogsResult(
