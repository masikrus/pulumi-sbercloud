...
class FgsFunctionEventArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] content: The function event content.
        :param pulumi.Input[builtins.str] function_urn: The URN of the function to which the event blongs.
        :param pulumi.Input[builtins.str] name: The function event name.
        :param pulumi.Input[builtins.str] region: The region where the function event is located.
        """
