...
class FgsFunctionTriggerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] event_data: The detailed configuration of the function trigger event, in JSON format.
        :param pulumi.Input[builtins.str] function_urn: The function URN to which the function trigger belongs.
        :param pulumi.Input[builtins.str] type: The type of the function trigger.
        :param pulumi.Input[builtins.str] region: The region where the function trigger is located.
        :param pulumi.Input[builtins.str] status: The expected status of the function trigger.
        """
