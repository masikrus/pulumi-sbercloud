...
class DmsRocketmqUserArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] access_key: Specifies the access key of the user.
        :param pulumi.Input[builtins.str] instance_id: Specifies the ID of the rocketMQ instance.
        :param pulumi.Input[builtins.str] secret_key: Specifies the secret key of the user.
        :param pulumi.Input[builtins.bool] admin: Specifies whether the user is an administrator.
        :param pulumi.Input[builtins.str] default_group_perm: Specifies the default consumer group permissions. Value options: **PUB|SUB**, **PUB**, **SUB**, **DENY**.
        :param pulumi.Input[builtins.str] default_topic_perm: Specifies the default topic permissions. Value options: **PUB|SUB**, **PUB**, **SUB**, **DENY**.
