...
__all__ = [
    'GetCfwAccessControlLogsResult',
    'AwaitableGetCfwAccessControlLogsResult',
    'get_cfw_access_control_logs',
    'get_cfw_access_control_logs_output',
]

@pulumi.output_type
class GetCfwAccessControlLogsResult:
    """
    ...
    @property
    @pulumi.getter
    def records(self) -> Sequence['outputs.GetCfwAccessControlLogsRecordResult']:
...
class AwaitableGetCfwAccessControlLogsResult(GetCfwAccessControlLogsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCfwAccessControlLogsResult(
            action=self.action,
            app=self.app,
...
def get_cfw_access_control_logs(action: Optional[builtins.str] = None,
                                ...
                                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCfwAccessControlLogsResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('sbercloud:index/getCfwAccessControlLogs:getCfwAccessControlLogs', __args__, opts=opts, typ=GetCfwAccessControlLogsResult).value

    return AwaitableGetCfwAccessControlLogsResult(
...
def get_cfw_access_control_logs_output(action: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                       ...
                                       opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetCfwAccessControlLogsResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('sbercloud:index/getCfwAccessControlLogs:getCfwAccessControlLogs', __args__, opts=opts, typ=GetCfwAccessControlLogsResult)
    return __ret__.apply(lambda __response__: GetCfwAccessControlLogsResult(
