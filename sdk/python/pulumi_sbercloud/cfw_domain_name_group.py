...
__all__ = ['CfwDomainNameGroupArgs', 'CfwDomainNameGroup']

@pulumi.input_type
class CfwDomainNameGroupArgs:
    def __init__(__self__, *,
                 fw_instance_id: pulumi.Input[builtins.str],
                 object_id: pulumi.Input[builtins.str],
                 type: pulumi.Input[builtins.int],
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 domain_names: Optional[pulumi.Input[Sequence[pulumi.Input['CfwDomainNameGroupDomainNameArgs']]]] = None,
        ...
        :param pulumi.Input[builtins.str] description: Specifies the description of the domain name group.
        :param pulumi.Input[Sequence[pulumi.Input['CfwDomainNameGroupDomainNameArgs']]] domain_names: Specifies the list of domain names.
    ...
    def domain_names(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['CfwDomainNameGroupDomainNameArgs']]]]:
        """
    ...
    @domain_names.setter
    def domain_names(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['CfwDomainNameGroupDomainNameArgs']]]]):
...
@pulumi.input_type
class _CfwDomainNameGroupState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['CfwDomainNameGroupDomainNameArgs']]] domain_names: Specifies the list of domain names.
        :param pulumi.Input[builtins.str] fw_instance_id: Specifies the firewall instance ID.
        :param pulumi.Input[builtins.str] message: The message of the domain name group.
        :param pulumi.Input[builtins.str] name: Specifies the name of the domain name group.
        :param pulumi.Input[builtins.str] object_id: Specifies the protected object ID.
...
class CfwDomainNameGroup(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 domain_names: Optional[pulumi.Input[Sequence[pulumi.Input[Union['CfwDomainNameGroupDomainNameArgs', 'CfwDomainNameGroupDomainNameArgsDict']]]]] = None,
                 fw_instance_id: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 object_id: Optional[pulumi.Input[builtins.str]] = None,
                 region: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 __props__=None):
        """
        Create a CfwDomainNameGroup resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[builtins.str] description: Specifies the description of the domain name group.
        :param pulumi.Input[Sequence[pulumi.Input[Union['CfwDomainNameGroupDomainNameArgs', 'CfwDomainNameGroupDomainNameArgsDict']]]] domain_names: Specifies the list of domain names.
        :param pulumi.Input[builtins.str] fw_instance_id: Specifies the firewall instance ID.
        :param pulumi.Input[builtins.str] name: Specifies the name of the domain name group.
        :param pulumi.Input[builtins.str] object_id: Specifies the protected object ID.
        :param pulumi.Input[builtins.int] type: Specifies the type of the domain name group.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: CfwDomainNameGroupArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a CfwDomainNameGroup resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param CfwDomainNameGroupArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(CfwDomainNameGroupArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = CfwDomainNameGroupArgs.__new__(CfwDomainNameGroupArgs)
        ...
        super(CfwDomainNameGroup, __self__).__init__(
            'sbercloud:index/cfwDomainNameGroup:CfwDomainNameGroup',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            ref_count: Optional[pulumi.Input[builtins.int]] = None,
            region: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.int]] = None) -> 'CfwDomainNameGroup':
        """
        ...
        __props__ = _CfwDomainNameGroupState.__new__(_CfwDomainNameGroupState)
        ...
        __props__.__dict__["region"] = region
        __props__.__dict__["type"] = type
        return CfwDomainNameGroup(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="domainNames")
    def domain_names(self) -> pulumi.Output[Optional[Sequence['outputs.CfwDomainNameGroupDomainName']]]:
        """
        Specifies the list of domain names.
        """
        return pulumi.get(self, "domain_names")
