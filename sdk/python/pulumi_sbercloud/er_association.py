...
__all__ = ['ErAssociationArgs', 'ErAssociation']

@pulumi.input_type
class ErAssociationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] attachment_id: The ID of the attachment corresponding to the association.
        :param pulumi.Input[builtins.str] instance_id: The ID of the ER instance to which the route table and the attachment belongs.
        :param pulumi.Input[builtins.str] route_table_id: The ID of the route table to which the association belongs.
        :param pulumi.Input[builtins.str] region: The region where the ER instance and route table are located.
        """
...
class ErAssociation(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a ErAssociation resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: ErAssociationArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a ErAssociation resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param ErAssociationArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ErAssociationArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ErAssociationArgs.__new__(ErAssociationArgs)
        ...
        super(ErAssociation, __self__).__init__(
            'sbercloud:index/erAssociation:ErAssociation',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            route_table_id: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            updated_at: Optional[pulumi.Input[builtins.str]] = None) -> 'ErAssociation':
        """
        ...
        __props__ = _ErAssociationState.__new__(_ErAssociationState)
        ...
        return ErAssociation(resource_name, opts=opts, __props__=__props__)
