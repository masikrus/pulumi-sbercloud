...
func NewVpc(ctx *pulumi.Context,
	...
	var resource Vpc
	err := ctx.RegisterResource("sbercloud:index/vpc:Vpc", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVpc(ctx *pulumi.Context,
	...
	var resource Vpc
	err := ctx.ReadResource("sbercloud:index/vpc:Vpc", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Deprecated: use huaweicloudVpcRouteTable data source to get all routes
func (o VpcOutput) Routes() VpcRouteTypeArrayOutput {
	return o.ApplyT(func(v *Vpc) VpcRouteTypeArrayOutput { return v.Routes }).(VpcRouteTypeArrayOutput)
}
