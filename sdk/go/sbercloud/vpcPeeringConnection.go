...
func NewVpcPeeringConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("sbercloud:index/vpcPeeringConnection:VpcPeeringConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVpcPeeringConnection(ctx *pulumi.Context,
	...
	var resource VpcPeeringConnection
	err := ctx.ReadResource("sbercloud:index/vpcPeeringConnection:VpcPeeringConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (o VpcPeeringConnectionOutput) Description() pulumi.StringOutput {
	return o.ApplyT(func(v *VpcPeeringConnection) pulumi.StringOutput { return v.Description }).(pulumi.StringOutput)
}
...
func (o VpcPeeringConnectionOutput) PeerTenantId() pulumi.StringOutput {
	return o.ApplyT(func(v *VpcPeeringConnection) pulumi.StringOutput { return v.PeerTenantId }).(pulumi.StringOutput)
}
