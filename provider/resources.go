...
const (
	...
	mainPkg = "sbercloud"
	// modules:
	mainMod = "index" // the sbercloud module
)

//go:embed cmd/pulumi-resource-sbercloud/bridge-metadata.json
var metadata []byte
...
func Provider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		...
		//
		//    - In provider/cmd/pulumi-tfgen-sbercloud/main.go, replace the
		...
		//
		//    - In provider/cmd/pulumi-resource-sbercloud/main.go, replace the
		...
		//
		//      	tfbridge.Main(context.Background(), "sbercloud", sbercloud.Provider(),
		...
		// convention is to have a function at "github.com/sbercloud-terraform/terraform-provider-sbercloud/provider".New
		...
		Keywords:   []string{"sbercloud", "category/cloud"},
		License:    "Apache-2.0",
		...
		Golang: &tfbridge.GolangInfo{
			...
			ImportBasePath: path.Join(
				"github.com/masikrus/pulumi-sbercloud/sdk/",
