module github.com/masikrus/pulumi-sbercloud/provider
...
require (
	...
	github.com/sbercloud-terraform/terraform-provider-sbercloud v1.12.9
)
...
require (
	...
	github.com/huaweicloud/terraform-provider-huaweicloud v1.73.3 // indirect
